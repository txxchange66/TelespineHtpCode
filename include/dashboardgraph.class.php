<?php
//============================================================================
// DashboardGraph Class. PHP Class to draw bar graphs.
// Version: 1.0
...
class DashboardGraph
{
   ...
   /** 
    * constructor Create an DashboardGraph object.
    *
    ...
    * @returns null
    */
    function DashboardGraph($width = 400, $height = 300)
    {
         register_shutdown_function(array(&$this, '_DashboardGraph'));
...
/*        foreach($this->data as $key => $value)
    ...
    */
    function drawTitles()
    {
        ...
        // Main title
        imagettftext($this->img, 10, 0, $this->graphWidth/2-strlen($this->graphTitle)-20, $this->textPadding+15, $this->colorText, "./font/verdana.ttf", $this->graphTitle);
        // Y-axis title
        ...
        // X-axis title
        imagettftext($this->img, 10, 0, ($this->graphWidth/2-strlen($this->graphXTitle))+5, $this->posYEnd+$this->textPadding+($this->maxTextLength*6+10), $this->colorText, "./font/verdana.ttf", $this->graphXTitle);
    }
