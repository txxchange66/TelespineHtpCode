...
/*
$Id: class.nusoap_base.php,v 1.1 2008/03/14 05:52:20 manojv Exp $
...
* @version  $Id: class.nusoap_base.php,v 1.1 2008/03/14 05:52:20 manojv Exp $
* @access   public
*/
class nusoap_base {
	/**
	...
	*/
	...
	'http://www.w3.org/2001/XMLSchema' => array(
		...
		'unsignedLong'=>'','unsignedInt'=>'','unsignedShort'=>'','unsignedByte'=>'','positiveInteger'=>'','RecordRef'=>'RecordRef'),
	...
	*/
	function serialize_val($val,$name=false,$type=false,$name_ns=false,$type_ns=false,$attributes=false,$use='encoded'){
		$this->debug("in serialize_val: name=$name, type=$type, name_ns=$name_ns, type_ns=$type_ns, use=$use FRED");
		$this->appendDebug('Object type=' . $val instanceof soapval ? 'IS INSTANCEOF' : 'NOT INSTANCEOF');
		$this->appendDebug('value=' . $this->varDump($val));
		$this->appendDebug('attributes=' . $this->varDump($attributes));
    	if(is_object($val) && ($val instanceof soapval)){
