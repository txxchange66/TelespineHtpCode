...
class PostGraph
{
    ...
    */
    function drawBars()
    {
        ...
        foreach($this->data as $key => $value) 
        {
            $barWidth = (0.50*($this->posXEnd-$this->posXStart)/$this->countData)/2;
    ...
    */
    function drawTitles()
    {
        ...
        // Y-axis title
        @imagettftext($this->img, 12, 90, $this->textPadding + 18, ($this->graphHeight/2+strlen($this->graphYTitle)*3) + 5, $this->colorText, "/font/verdana.ttf", $this->graphYTitle);
        // X-axis title
        @imagettftext($this->img, 12, 0, ($this->graphWidth/2-strlen($this->graphXTitle)*3) - 12, $this->posYEnd+$this->textPadding+($this->maxTextLength*6+20) - 0, $this->colorText, "/font/verdana.ttf", $this->graphXTitle);
    }
