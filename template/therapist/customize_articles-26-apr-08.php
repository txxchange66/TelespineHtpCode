<div id="container">
	...
	<div id="breadcrumbNav">
		<a href="index.php?action=therapistPlan"> MY TX PLANS </a><!patient_name>
		...
		<tr>
			...
			function handleAction(s, id ,a_id)
			{
				...
				if (c) window.location.href = 'index.php?action=customize_articles&plan_id=<!plan_id>&sort=<!sort>&order=<!order>&' + 'act=' + a + '&article_id=' + id;
			}
...
<input type="image" src="/images/btn-back.jpg" value=" Back " onClick="window.location.href='<!back_url>'" />					
&nbsp;<!type_of_button>
</td>
