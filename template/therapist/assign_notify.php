<div id="container">
	...
	<div id="breadcrumbNav">
		<a href="index.php?action=therapistPlan"><!path_name></a>
	...
	<h1 class="largeH1">Confirm Plan Assignment</h1>
	...
	<br />
	<span style="font-weight:bolder; font-size:16px;">You are about to assign a plan to <!name_title> <!name_first> <!name_last></span>
	<br /><span>By notifying, your patient will receive an email asking them to log into Tx
Xchange to view their new plan.</span><br /><br />
	<div align="left">
		<form name="assignform" enctype="multipart/form-data" method="POST" action="index.php?action=therapistPlan" onSubmit="return validate_form(this);">

		<a href="index.php?action=assigned_plan_patient&notify=1&plan_id=<!plan_id>&patient_id=<!patient_id>" ><img src="images/btn-assign-notify.jpg" alt="Assign &amp; Notify" /></a>
		
		<a href="index.php?action=assigned_plan_patient&plan_id=<!plan_id>&patient_id=<!patient_id>" ><img src="images/btn-assign-nonotify.jpg" alt="Assign w/o Notification" /></a>
