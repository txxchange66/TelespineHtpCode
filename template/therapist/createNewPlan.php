...
<table style="vertical-align:middle; width:700px;padding-top:15px;"><tr><td style=" width:400px;"><div id="breadcrumbNav">
...
<table cellpadding="0" cellspacing="0" border="0">
	<tr>
		...
		<br>
<form name="detailform" id="detailform" enctype="multipart/form-data" method="POST" action="index.php?action=createNewPlan" >			
