<div id="container">
	...
	<!--
		...
		{
			if(! g_plan_win) var g_plan_win = window.open('/patient/plan_viewer.php?id='+id, 'g_plan_win', 'width=969,height=688,scrollbars=auto');
			g_plan_win.focus();
		}
...
<!-- buttons -->
<div style="width:290px; float:right;" align="right">
	...
	<tr>
		...
		<td class="iconLabel"><a href="index.php?action=createNewPlan"><img src="<!imageCreateNewTemplatePlan>" width="127" height="81" alt="Create New Template Plan" ></td>
	</tr>
	</table>
</div>
</td>
...
<h1 class="largeH1"><span>Recent Messages</span><span align="right" style="padding-left:446px;"><a onMouseOver="help_text(this, 'Click here to compose a new message')" style="color: white;" href="index.php?action=compose_message">Compose New Message</a></span></h1> 
...
<!current_patient_activity>
		...
		<td valign="top" style="width:280px;"><!mainTopAssignedPlans>
    </td>
	</tr>
</table>
</div>
