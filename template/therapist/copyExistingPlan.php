...
<a href="index.php?action=therapistPlan">TEMPLATE LIBRARY</a><!patient_name>/ <span class="highlight">PLAN NAME</span></div></td>
...
<table cellpadding="0" cellspacing="0" border="0">
	<tr>
		...
		<br>
<form name="detailform" id="detailform" enctype="multipart/form-data" method="POST" action="index.php?action=copyExistingPlan" >			
