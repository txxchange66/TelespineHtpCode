...
window.formRules = new Array(	
	...
	new Rule("therapistName", "provider name", true, "string|0,250"));
...
<form name="retrieve_form" id="retrieve_form" method="POST" action="index.php?action=loginRecovery3" onSubmit="return validate_form(this);">

<table border="0" cellpadding="2" cellspacing="0" width="100%" class="form_container">

<tr class="inputRow">

	<td><label for="question_id" onMouseOver="help_text(this, 'Choose Provider first name')">*&nbsp;Secret Question&nbsp;</label></td>



	<td><select name="question_id" id="question_id" onMouseOver="help_text(this, 'Choose Provider first name')">
...
<tr class="inputRow">
	...
	<td><div style="width:160px"><label for="therapistName" onMouseOver="help_text(this, 'Please Enter the Provider First Name')">*&nbsp;Answer&nbsp;</label></div></td>

	<td width="100%"><input type="text" name="therapistName" id="therapistName" size="20" onMouseOver="help_text(this, 'Please Enter the Provider First Name')" value="<!therapistName>"/></td>
...
<tr class="inputRow">
	...
	<input type="hidden" name="submit" id="submit" value="Retrieve Password3"/>
