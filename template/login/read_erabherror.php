...
<body><span id="error" style="color:#FF0000;font-weight:bold;"></span>
<div class="pop-up-con">	   
    <table border="0" cellpadding="0" cellspacing="0" style="width: 100%">
		<span style="font:inherit ;color:black;"><!personalmessage></span>
		<div style="position:relative;padding-left:200px; padding-top:10px;">
        <input type="button" value="Close" onclick = "parent.parent.GB_hide();" />
    </div>
	</table>
</div>
