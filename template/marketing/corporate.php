    ...
    <div id="mainContent">
      <table border="0" cellpadding="0" cellspacing="0" style="vertical-align:middle; width:100%; height:81px;">
        <tr>
         ...
         <tr>
          <td width="151" style=" width:400px;"><div id="breadcrumbNav" style="margin-top:26px;"> <a href="index.php">HOME</a> /  CUSTOMIZE /<span class="highlight"  > EHS INTRO EMAIL</span></div></td>
          <td width="138"></td>
...
<br>
EHS Introductory Email functionality is not applicable to Corporate EHS Account.
