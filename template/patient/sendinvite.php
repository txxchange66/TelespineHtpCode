...
Send all the health, wellness, and fitness professionals you go to an invite to join Tx Xchange. When they join, you'll be able to securely interact with them online, ask them questions between visits or sessions, and follow the personalized  information and guidance they'll give to you. Thanks for letting Tx Xchange provide you with a more convenient and engaging health, wellness, or fitness experience.
	   
    <table cellpadding="4" cellspacing="0" style="width: 100%">
		<form name="sendinvite" id="sendinvite" action="/index.php" method="post" >
		<tr>
          <td colspan="3" class="error"><!error>&nbsp;<input  type="hidden" name="action" value="sendinvite_send"/></td>
           </tr>
		<tr>
