                             ...
                             <tr>
                               ...
                               <td width="91%"  style="padding-top:3px;" ><table width="100%" cellpadding="0" cellspacing="0">
                                   <tr>
                                     ...
                                     <input type="text" id="patient_name" style="width:665px;" name="patient_name" size="800" value="ALL EHS PATIENTS" readonly="readonly">
									<input type="hidden" id="patient_name_hidden" name="patient_name_id" value="-4" >
                                     </td>
                                   </tr>
                               </table></td>
                             </tr>
                                   ...
                                   <tr>
                                     ...
                                     <td width="63%" align="right">
                                     	<input type="submit" name="Submit" id="button" value="Submit Message" />
                          				<input type="hidden" name="action" value="compose_message_ehs"/>
