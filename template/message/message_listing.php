      ...
      <td width="84%"  align="left" valign="top">
      	<div id="mainContent"  >
				...
				<tr>
					<td valign="middle" style=" width:400px; height:">
						<div id="breadcrumbNav" style="vertical-align:middle;  "> 
							<a href="index.php">HOME</a> / <span class="highlight"  >MESSAGE CENTER</span>
						</div>
					</td>
					<td>
					...
					<td style="padding-left:176px; margin-top:11px;">
						<a href="index.php?action=compose_message" ><img src="images/img-compose-message.gif" alt=""  /></a>
					</td>
				</tr>
			</table>
			<table border="0" cellpadding="00" cellspacing="0"   width="100%">
                ...
                <tr>
					<td  class="largeH1" style="valign:middle;padding-left:13px;">Message Center	</td>
				</tr>
				<tr>
