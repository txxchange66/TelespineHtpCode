...

{
            ...
            window.location.href = 'index.php?action=deleteUserSystem&' +'id=' + id;                          
...
<table width="75%" border="0" cellspacing="0" cellpadding="0" align="center">
  ...
  <tr>
    ...
    <td style="padding-left:25px; padding-right:25px;"><strong>You have selected to delete this Provider. By doing so this user will not be able to create or assign plans to the patients.</strong></td>
