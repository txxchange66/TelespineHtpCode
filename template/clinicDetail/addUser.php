...
//	alert(document.getElementById('errorDiv').innerHTML);
  //  alert(document.getElementById('errorDiv').innerHTML.length);
	if (document.addUserForm.therapistAccess.checked == true)
	{
		checkValidationSystem('NA',<!clinic_id>);
	}
	else
	{
          ...
          <table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
			  ...
			  <table width="100%" border="0" style="vertical-align:middle; width:700px; ">
                  <tr>
                    <td>
                    <table style="vertical-align:middle;width:700px;margin-top:40px;margin-bottom:5px;">
                        <tr>
                          <td style="width:400px;">
                          <div id="breadcrumbNav" >
                          <a href="index.php?action=sysAdmin" >HOME </a> / <a href="index.php?action=listClinic" >ACCOUNT</a> / <span class="highlight"><!account_name></span> / <span class="highlight">ADD USER</span>
                          </div></td>
                          </tr>
                    </table>
                                  ...
                                  <tr>
                                    <td width="46%"><div>
                                        <table border="0" cellspacing="2" cellpadding="2" width="100%">
                                          ...
                                          <tr class="inputRow">
                                            <td>
                                                <div align="right"><label onMouseOver="help_text(this, 'Set the account privileges for the user')")>
											*&nbsp;Account Privileges :&nbsp;</label></div></td>
                                    ...
                                    <td colspan="2" valign="top"><table cellspacing="2" cellpadding="2" width="100%">
                                        <tr>
                                          <td width="24%">&nbsp;</td>
                                          <td><input type="checkbox" name="clinicAddress" onMouseOver="help_text(this, 'Put the check mark if the user address is same as clinic address.')" class="checkBoxAlign" <!checkedAddress> onclick="populateAddress('Add',<!clinic_id>);" />
                                            <span onMouseOver="help_text(this, 'Put the check mark if the user address is same as clinic address.')"> Address Same as Clinic </span> </td>
                                        </tr>
                                        <tr>
                                          <td>&nbsp;</td>
                                          <td>&nbsp;</td>
