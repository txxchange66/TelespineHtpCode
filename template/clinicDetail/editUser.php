...
function popupConfirm()
{
	...
	{
		checkValidationSystem(userId,<!clinic_id>);	
	}
	else
	{
...
function showPopupMsg()
{
	...
	if (therapist_access == 1 && document.editUserForm.therapistAccess.checked == false)
	{
		if (patient_association == 1 )
		{
			if(!csw) 
			{
				var csw = window.open('index.php?action=showPopupMsgSystem&id='+userId + '&clinic_id=<!clinic_id>', 'showConfirmWindow', 'width=600, height=470, status=no, toolbar=no, resizable=no, scrollbars=no');
				csw.focus();	
			}	
		}
		else
		{	
			if(!csw) 
			{
				var csw = window.open('index.php?action=showPopupMsgSystem&id='+ userId + '&clinic_id=<!clinic_id>', 'showConfirmWindow', 'width=600, height=310, status=no, toolbar=no, resizable=no, scrollbars=no');
				csw.focus();	
			}
		}
	}
...
<form name="editUserForm" action="index.php" enctype="multipart/form-data" method="POST" >
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr>
      ...
      <div id="mainContent">
	  <!--  MAIN TABLE STARTS -->
          <table width="100%" border="0" cellspacing="0" cellpadding="0" style="vertical-align:middle;width:700px;margin-top:45px;margin-bottom:5px;">
            <tr>
              <td valign="top" align="left" style="width:400px;">
			  <!--  INNER MAIN TABLE STARTS (5) ROWS STARTS  -->
                <div id="breadcrumbNav" ><a href="index.php?action=sysAdmin" >HOME </a> / <a href="index.php?action=listClinic" >ACCOUNT</a> / <span class="highlight"><!account_name></span> / <span class="highlight">EDIT USER</span></div>
              </td>
            </tr>
          </table>
                                        ...
                                        <td colspan="2" valign="top">
                                            <table cellspacing="2" cellpadding="2" width="100%">
                                                <tr>
                                                    <td width="25%">&nbsp;</td>
                                                    <td>
                                                          <input type="checkbox" name="clinicAddress"  class="checkBoxAlign" <!checkedAddress> onclick="populateAddress('Edit',<!clinic_id>);" />
                                                    ...
                                                    <td colspan="2">
                                                        <div id="divAddress">
                                                            <table cellspacing="2" cellpadding="2" width="100%">
                                                                ...
                                                                <tr>
		                                                  <td><div align="right">
		                                                      <label for="city" onMouseOver="help_text(this, 'Enter the User\'s country')")>&nbsp;Country :&nbsp;</label>
		                                                    </div></td>
	...
	<input type="hidden" name="action" value="editUser_System"/>
