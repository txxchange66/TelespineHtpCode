...
<div id="container">
  <form name="clinicdetail" id="clinic_detail" action="index.php?action=addEditClinicInAccount" method="post">
          ...
          <table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
			  ...
			  <table width="100%" border="0" style="vertical-align:middle; width:700px; ">
                  <tr>
                    <td>
                    <table style="vertical-align:middle;width:700px;margin-top:23px;margin-bottom:7px;">
                        <tr>
                          <td style="width:400px;">
                          <div id="breadcrumbNav">
                            <a href="index.php?action=sysAdmin" >HOME </a> / <a href="index.php?action=listClinic" >ACCOUNT</a> / <span class="highlight"><!account_name></span> / <span class="highlight"><!heading1></span>
                          </div>
                          </td>
                          <td style="width:300px;">
                          <table border="0" cellpadding="5" cellspacing="0" style="float:right;margin-top:27px;margin-bottom:3px;">
                              <tr>
                     ...
                     <div > 
                      <table width="100%" border="0" cellspacing="2" cellpadding="2" style="border:1px solid #CCCCCC;">
						  ...
						  <tr>
                            ...
                            <td><input type="text" tabindex="7" name="clinic_phone" value="<!clinic_phone>" ></td>
						  </tr>
...
<tr>
                      ...
                      <div style="float:right;" >
						<input type="submit" tabindex="8" name="Submit" value=" Save Changes " />                        
                      </div></td>
                  </tr>
				  <!--  4th ROW ENDS  -->
                  <tr>
