...
if(country == 'CAN')
{
	document.getElementById('country').innerHTML = 'Canada';
     ...
     for(var a in canadastateArray){
         if(window.opener.document.getElementById('state').value == a){
    	 
        	 document.getElementById('state').innerHTML = canadastateArray[a];
...
for(var b in usstateArray){
    if(window.opener.document.getElementById('state').value == b){
	 
   	 document.getElementById('state').innerHTML = usstateArray[b];
...
<table cellspacing="2" cellpadding="2" width="100%">
  ...
  <tr>
    <td nowrap="nowrap"><div align="right"><label for="country" >Country :&nbsp;</label>
    </div></td>
    <td><div name="country" id="country"></div>   </td>
  </tr>
  <tr>
