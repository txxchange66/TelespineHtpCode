...
<table style="vertical-align:middle; width:700px; margin-top:35px;"  border="0">
	...
	<div>				
		<form method="POST" action="index.php" name="filter" onsubmit="return search_key(document.filter.search.value);" >
            ...
            <input type="hidden" name="action" value="invite_list" >
			<input type="submit" size="20" name="sub" value=" Search ">
            <input type="button" size="20" name="all_user" value=" Show Members " onclick="javascript:window.location.href='?index.php&action=invite_list'" >
		</form>
	</div>
	</td>
	<td align="right"></td>
