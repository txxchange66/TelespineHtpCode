...
<table border="0" cellpadding="0" cellspacing="0" style="vertical-align:middle; width:100%; height:81px;">
  ...
  <tr>
    <td colspan="5" style="width:741px;">
        <div id="breadcrumbNav" style="padding-left:6px;margin-top:33px;float:left;width:550px;">
            <a href="index.php">HOME</a> / <span class="highlight"  >  <a href="index.php?action=accountAdminClinicList">ACCOUNT</a>/ MARKETING</span>
        </div>
    </td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <div style="padding-top:32px;width:741px;float:left;">
            <!tabNavigation>
    </div> </td>
    </tr>
     <tr>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" onMouseOver="help_text(this, 'View Clinic Details')" style="border:1px solid #CCCCCC;">
						  ...
						  <tr>
							<td colspan="2" valign="top" class="text">
							  ...
							  <input type="hidden" name="action" value="bulletinBoardHead" />
