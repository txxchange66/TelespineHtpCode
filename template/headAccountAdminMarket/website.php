...
my_form.content.value = my_form.clinic_overview.value.substring(0, maxLen);
...
<div class="center-align" >
  <div id="container">
    ...
    <div id="mainContent-sec">
      <table border="0" cellpadding="0" cellspacing="0" style="vertical-align:middle; width:100%; height:81px;">
        ...
        <tr>
          <td width="151" style=" width:400px;"><div id="breadcrumbNav" style="padding-left:6px;margin-top:12px;"> <a href="index.php">HOME</a> / <span>MARKETING</span> / <span class="highlight">COMPANY DETAILS</span></div></td>
          <td width="138"></td>
 ...
 <form action="index.php" method="post" name="frm" enctype="multipart/form-data" onSubmit="return checkLength();">
      ...
      <tr><td>
        ...
        <tr>
          <td class="marketingtitle" width="182px">Company Details</td>
        ...
        <td colspan="2">&nbsp;</td>
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" name="clinic_url" value="<!clinic_url>"  style="width:145px;"/><span style="font-size:9px;font-weight:normal;">(e.g. 
						<a href="http://www.google.com">http://www.google.com</a>)</span>
                        </td>
                </tr>
                ...
                <tr>
                    ...
                    (Image size: <!width>X<!height>, Types: jpeg, gif, png)
                    </td>
                </tr>
                <tr><td colspan="2">&nbsp;</td></tr>
                <tr>
                    <td align="center" colspan="2" >
                        <input type="hidden" name="action" value="websiteHead" />
                ...
                <tr>
                    ...
                    <td><div style="height:5px;"></div>
                        <textarea onMouseOver="help_text(this, 'Please enter the Company Overview')" name="clinic_overview" rows="3" cols="15" style="width:345px;" onKeyup="check_length(this.form);"><!clinic_overview></textarea>
                        <!---->
