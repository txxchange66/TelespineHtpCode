...
<input type="button" value="No" onclick = "parent.parent.window.location.href='/index.php?action=HeadAdminEditPatients&patient_id=<!userId>&clinic_id=<!clinicId>';parent.parent.GB_hide();"  style="width:44px;text-align:center;"  />
    </form>
    </div>
