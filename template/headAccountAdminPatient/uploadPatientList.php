  ...
  <div id="container">
    ...
    <div id="mainContent-sec">
      <table border="0" cellpadding="0" cellspacing="0" style="vertical-align:middle; width:100%; height:81px;">
        <tr>
          <td colspan="3" style=" width:400px; height:16px;"></td>
        </tr>
        <tr>
          <td width="151" style=" width:400px;"><div id="breadcrumbNav" style="padding-left:6px;margin-top:-1px;"> <a href="index.php">HOME</a> / <span class="highlight"  > <a href="index.php?action=accountAdminClinicList">ACCOUNT /</a> UPLOAD PATIENT LIST</span></div></td>
          <td width="138"></td>
