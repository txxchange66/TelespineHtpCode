...
<div id="mainContent">
<table style="vertical-align:middle;width:700px;"><tr><td style="width:400px;"><div id="breadcrumbNav"><a href="index.php?action=therapistLibrary" >ARTICLE</a> / <span class="highlight">CREATE ARTICLE</span></div></td><td style="width:300px;"><table border="0" cellpadding="5" cellspacing="0" style="float:right;">
<tr>
...
<table border="0" cellpadding="2" cellspacing="1" width="100%" class="form_container">
	<tr class="input">
		...
		<td width="100%"><input type="hidden" name="submitted_save" value="Add Article">
			<input type="hidden" name="action" value="articleCreateThpst" />
			<a  href="index.php?action=confirmPopupTherapistArticleCreate"  rel="gb_page_center[600, 310]"><input type="button" name="submitted_save" value="Save Article & Publish"></a>
			</td>
	</tr>
</table>
</div>
