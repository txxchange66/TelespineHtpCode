...
<script language="JavaScript">
<!--
function handleAction(s,ptId ,id)
{
	...
	if (c) window.location.href = 'index.php?action=removeReminderEhs&therpaistId='+ptId+'&id=' + id;
}
function doClose()
{
	if(window.opener)
...
<form name="detailform" id="detailform" enctype="multipart/form-data" method="POST" action="index.php?action=addReminderEhs&therpaistId=<!therpaistId>" onSubmit="return validate_form(this);">
