...
<form name="detailform" id="detail_form" enctype="multipart/form-data" method="POST" action="index.php?action=editClinicSubscriber" onsubmit="if (isValidEmail(document.forms['detailform'].username.value)) { return true; } else { alert('NOT a valid email address');return false; }">
