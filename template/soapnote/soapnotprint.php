...
$(document).ready(function()
{
  ...
  //$('#mainContent1').attr();  
  $('#mainContent1 :input').attr('readonly', true);
...
/*$("#mainContent1 textarea").each(function(){
	var elementname = $(this);
	for(var prop in data1){
	    var statevalue=data1[prop];
	    var test=$("#mainContent textarea");
	    if(prop =='cc_id1')
		    cc1=1;
	    if(prop =='cc_id2')
		    cc2=1;
	    if($(elementname).attr("name")==prop){
		    $(this).val(URLDecode(statevalue));
		      }
	  }
});
$("#mainContent1 input").each(function(){
	var elementname = $(this);
	for(var prop in data1){
	    var statevalue=data1[prop];
	    
	    var test=$("#mainContent1 input");
...
<div id="container1" style="width:720px; margin:0px auto; padding:30px 0 30px 0;">	
<div id="mainContent1" style="border-left:none; ">
<div style="clear:both;"></div>
<div style="border:#ccc 0px solid;padding:0px; margin-top:0px;">
<div style="background:url(/images/img-topnav-repeat.gif) top left repeat-x; height:30px;"></div>
<div class="divHeader">
<table cellpadding="5" cellspacing="0" style="width: 690px; padding:10px 0 20px 0;" class="soap-note-subj" align="center">
<tr><td>Patient's Name:</td><td style="font-weight: normal; width:320px;"><!patientname></td><td>Date Of Birth:</td><td style="font-weight: normal;"><!dateofbirth></td></tr>
<tr><td>Doctor's Name:</td><td style="font-weight: normal;"><!providername></td><td>Date Of Service:</td><td style="font-weight: normal;"><!soap_date></td></tr>
<tr><td>Clinic Name:</td><td style="font-weight: normal;"><!clinicname></td><td>Clinic Tel No.:</td><td style="font-weight: normal;"><!phone></td></tr>
<tr><td>Clinic Address:</td><td style="font-weight: normal;"><!clinicaddress></td><!--<td>Page No.:</td><td style="font-weight: normal;"><span id="pageNumber"></span></td>--></tr>
</table>
</div>
<html><body>
<div id="subjective" class="mydiv"><div style="padding-top: 30px;"><b>Subjective</b></div>

<table cellpadding="5" cellspacing="0" style="width: 690px;" class="soap-note-subj" align="center">
    <tr><td>&nbsp;</td>
		<td >Chief Complaint<br/><textarea class="expand" name="chief_complaint"  ></textarea></td>

	</tr></table>

<table cellpadding="5" cellspacing="0" style="width: 690px;" class="soap-note-subj">	
	<tr><td style="width:10px; font-size:18px; color:#00699d;" class="linkCol" valign="top">  </td><td class="heading" >History of Present Illness</td></tr>
	</table>
<div id="history">	
<table cellpadding="5"  cellspacing="0" style="width: 690px;" class="soap-note-subj" align="center">
	<tr><td>&nbsp;</td>
...
<table cellpadding="5" cellspacing="0" style="width: 690px;" class="soap-note-subj">
	<tr><td style="width:10px; font-size:18px; color:#00699d;" class="linkCol"> </td><td class="heading">Review of Systems</td></tr>
	</table>
<div id="review">
<table cellpadding="5" cellspacing="0" style="width: 690px;" class="soap-note-subj" align="center">
<tr><td>&nbsp;</td>
...
<div id="ccc1"><table cellpadding="5" cellspacing="0" style="width: 690px;" class="soap-note-subj" align="center">
	<tr><td>&nbsp;</td>
		<td >Chief Complaint<br/><textarea class="expand" name="chief_complaint1"  ></textarea></td>

	</tr></table><table cellpadding='5' cellspacing='0' style='width: 690px;' class='soap-note-subj'><tr><td style='width:10px; font-size:18px; color:#00699d;' class='linkCol' valign='top'>  </td><td class='heading' >History of Present Illness</td></tr></table><div id='history1'><table cellpadding='5'  cellspacing='0' style='width: 690px;' class='soap-note-subj' align='center'><tr><td>&nbsp;</td><td >Location<br/><textarea class='expand' name="location1" ></textarea></td></tr><tr><td>&nbsp;</td><td >Onset<br/><textarea class='expand' name="onset1" ></textarea></td></tr><tr><td>&nbsp;</td><td >Provocation<br/><textarea class='expand' name="provocation1"  ></textarea></td></tr><tr><td>&nbsp;</td><td >Palliation<br/><textarea class='expand' name="palliation1"  ></textarea></td></tr><tr><td>&nbsp;</td><td >Quality<br/><textarea class='expand' name="quality1"  ></textarea></td></tr><tr><td>&nbsp;</td><td >Radiation<br/><textarea class='expand' name="radiation1"  ></textarea></td></tr><tr><td>&nbsp;</td><td>Severity<br/><textarea class='expand' name="severity1" ></textarea></td></tr><tr><td>&nbsp;</td><td>Duration<br/><textarea class='expand' name="duration1" ></textarea></td></tr><tr><td>&nbsp;</td><td>Timing<br/><textarea class='expand' name="timing1" ></textarea></td></tr><tr><td>&nbsp;</td><td>Associated signs/symptoms<br/><textarea class='expand' name="associated_signs_symptoms1" ></textarea></td></tr></table></div><table cellpadding='5'cellspacing='0'style='width:690px;'class='soap-note-subj'><tr><td style='width:10px;font-size:18px;color:#00699d;'class='linkCol'></td><td class='heading'>Review of Systems</td></tr></table><div id='review1' ><table cellpadding='5' cellspacing='0' style='width:690px;' class='soap-note-subj' align='center'><tr><td>&nbsp;</td><td>Constitutional<br/><textarea class='expand' name="constitutional1" ></textarea></td></tr><tr><td>&nbsp;</td><td>Eyes<br/><textarea class='expand' name="eyes1" ></textarea></td></tr><tr><td>&nbsp;</td><td>Ears, nose, mouth, throat<br/><textarea class='expand' name="ears_nose_mouth_throat1" ></textarea></td></tr><tr><td>&nbsp;</td><td>Cardiovascular<br/><textarea class='expand' name="cardiovascular1" ></textarea></td></tr><tr><td>&nbsp;</td><td>Respiratory<br/><textarea class='expand' name="respiratory1" ></textarea></td></tr><tr><td>&nbsp;</td><td>Gastrointestinal<br/><textarea class='expand' name="gastrointestinal1" ></textarea></td></tr><tr><td>&nbsp;</td><td>Genital-urinary<br/><textarea class='expand' name="genital_urinary1" ></textarea></td></tr><tr><td>&nbsp;</td><td>Musculo-skeletal<br/><textarea class='expand' name="musculo_skeletal1" ></textarea></td></tr><tr><td>&nbsp;</td><td>Skin<br/><textarea class='expand' name="skin1" ></textarea></td></tr><tr><td>&nbsp;</td><td>Neurological<br/><textarea class='expand' name="neurological1" ></textarea></td></tr><tr><td>&nbsp;</td><td>Psychiatric<br/><textarea class='expand' name="psychiatric1" ></textarea></td></tr><tr><td>&nbsp;</td><td>Endocrine<br/><textarea class='expand' name="endocrine1" ></textarea></td></tr><tr><td>&nbsp;</td><td>Hematology/lymphatic<br/><textarea class='expand' name="hematology_lymphatic1" ></textarea></td></tr><tr><td>&nbsp;</td><td>Allergy/immunology<br/><textarea class='expand' name="allergy_immunology1" ></textarea></td></tr><tr><td>&nbsp;</td><td>&nbsp;</td></tr></table></div></div>
<div id="ccc2"><table cellpadding="5" cellspacing="0" style="width: 690px;" class="soap-note-subj" align="center">
	<tr><td>&nbsp;</td>
		<td >Chief Complaint<br/><textarea class="expand" name="chief_complaint2"  ></textarea></td>

	</tr></table><table cellpadding='5' cellspacing='0' style='width: 690px;' class='soap-note-subj'><tr><td style='width:10px; font-size:18px; color:#00699d;' class='linkCol' valign='top'>  </td><td class='heading' >History of Present Illness</td></tr></table><div id='history2'><table cellpadding='5'  cellspacing='0' style='width: 690px;' class='soap-note-subj' align='center'><tr><td>&nbsp;</td><td >Location<br/><textarea class='expand' name="location2" ></textarea></td></tr><tr><td>&nbsp;</td><td >Onset<br/><textarea class='expand' name="onset2" ></textarea></td></tr><tr><td>&nbsp;</td><td >Provocation<br/><textarea class='expand' name="provocation2"  ></textarea></td></tr><tr><td>&nbsp;</td><td >Palliation<br/><textarea class='expand' name="palliation2"  ></textarea></td></tr><tr><td>&nbsp;</td><td >Quality<br/><textarea class='expand' name="quality2"  ></textarea></td></tr><tr><td>&nbsp;</td><td >Radiation<br/><textarea class='expand' name="radiation2"  ></textarea></td></tr><tr><td>&nbsp;</td><td>Severity<br/><textarea class='expand' name="severity2" ></textarea></td></tr><tr><td>&nbsp;</td><td>Duration<br/><textarea class='expand' name="duration2" ></textarea></td></tr><tr><td>&nbsp;</td><td>Timing<br/><textarea class='expand' name="timing2" ></textarea></td></tr><tr><td>&nbsp;</td><td>Associated signs/symptoms<br/><textarea class='expand' name="associated_signs_symptoms2" ></textarea></td></tr></table></div><table cellpadding='5'cellspacing='0'style='width:690px;'class='soap-note-subj'><tr><td style='width:10px;font-size:18px;color:#00699d;'class='linkCol'></td><td class='heading'>Review of Systems</td></tr></table><div id='review2' ><table cellpadding='5' cellspacing='0' style='width:690px;' class='soap-note-subj' align='center'><tr><td>&nbsp;</td><td>Constitutional<br/><textarea class='expand' name="constitutional2" ></textarea></td></tr><tr><td>&nbsp;</td><td>Eyes<br/><textarea class='expand' name="eyes2" ></textarea></td></tr><tr><td>&nbsp;</td><td>Ears, nose, mouth, throat<br/><textarea class='expand' name="ears_nose_mouth_throat2" ></textarea></td></tr><tr><td>&nbsp;</td><td>Cardiovascular<br/><textarea class='expand' name="cardiovascular2" ></textarea></td></tr><tr><td>&nbsp;</td><td>Respiratory<br/><textarea class='expand' name="respiratory2" ></textarea></td></tr><tr><td>&nbsp;</td><td>Gastrointestinal<br/><textarea class='expand' name="gastrointestinal2" ></textarea></td></tr><tr><td>&nbsp;</td><td>Genital-urinary<br/><textarea class='expand' name="genital_urinary2" ></textarea></td></tr><tr><td>&nbsp;</td><td>Musculo-skeletal<br/><textarea class='expand' name="musculo_skeletal2" ></textarea></td></tr><tr><td>&nbsp;</td><td>Skin<br/><textarea class='expand' name="skin2" ></textarea></td></tr><tr><td>&nbsp;</td><td>Neurological<br/><textarea class='expand' name="neurological2" ></textarea></td></tr><tr><td>&nbsp;</td><td>Psychiatric<br/><textarea class='expand' name="psychiatric2" ></textarea></td></tr><tr><td>&nbsp;</td><td>Endocrine<br/><textarea class='expand' name="endocrine2" ></textarea></td></tr><tr><td>&nbsp;</td><td>Hematology/lymphatic<br/><textarea class='expand' name="hematology_lymphatic2" ></textarea></td></tr><tr><td>&nbsp;</td><td>Allergy/immunology<br/><textarea class='expand' name="allergy_immunology2" ></textarea></td></tr><tr><td>&nbsp;</td><td>&nbsp;</td></tr></table></div></div>
...
<div id="objective" class="mydiv"><b>Objective</b>

<table cellpadding="5" cellspacing="0" style="width: 690px;" class="soap-note-obj" align="center">
	<tr>
...
<div class="page-break"></div>
<div id="assessment"  class="mydiv"><b>Assessment</b>

<table cellpadding="5" cellspacing="0" style="width: 690px;" class="soap-note-ass" align="center">
...
<div class="page-break"></div>
<div id="program"  class="mydiv"><b>Program</b>

<table cellpadding="0" cellspacing="0" style="width: 690px;" align="center">
<tr><td>
...
<table cellpadding="0" cellspacing="0" style="width: 100%" class="soap-note-prog-bottom">
		...
		<tr>
			<td>Dietary Instructions:<br/><textarea class="expand" name="dietary_instructions" ></textarea></td>
		</tr>
                <tr>
										<td>&nbsp;</td>
									</tr>
...
<script type="text/javascript" src="/js/jquery.textarea-expanderprint.js"></script>	
