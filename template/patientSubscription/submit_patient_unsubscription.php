...
<table width="100%" border="0" style="position: absolute; top: 15px; left: 30px; width: 450px;">
    ...
    <tr>
        <td align="center" valign="bottom" height="60px" style="padding-right:18px;"><input type="button" value="OK" style="width:44px;text-align:center;" onclick = "parent.parent.window.location.href='/index.php?action=changePass';parent.parent.GB_hide();" /> </td>
    </tr>
</table>
