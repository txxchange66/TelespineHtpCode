...
<div style="float:right;color:#777; font-weight:300" class="hidden-sm hidden-xs">
<!date>
</div>
</h2>
</div>
	...
	<!-- Sign Up/ Billing -->
				<div class="box form-section"  id="billing">
					<div class="box-header">
						<!--<h2><i class="fa fa-tachometer"></i>Sign Up</h2>
					...
					<div class="box-content">
						<form action="index.php?action=submitpatientsignup" class="form-horizontal" id="billing-form" method="post"
										...
										<div class="form-group form-box">
											<div>
												<input class="form-control required" id="firstName" name="firstName"
													...
													data-role="not-blank" minlength="1" maxlength="35" title="Please enter your first name" pattern="^([ \u00c0-\u01ffa-zA-Z'\-]){2,50}$" required autofocus="autofocus">
												<span class="fa fa-asterisk form-indicator"></span> </div>
										</div>
									</div>
									<div class="col-lg-4 col-md-6 col-sm-12">
										<div class="form-group form-box">
											<div>
												<input class="form-control required" id="lastName" name="lastName"
													...
													data-role="not-blank" minlength="2" maxlength="45" title="Please enter your last name" pattern="^([ \u00c0-\u01ffa-zA-Z'\-]){2,50}$" required>
												<span class="fa fa-asterisk form-indicator"></span> </div>
										</div>
									</div>
										...
										<div class="form-group form-box">
											<div>
												<input class="form-control required" id="email" name="email"
													data-role="email" minlength="5" maxlength="135" pattern="[^@]+@[^@]+.[a-zA-Z]{2,6}"
													type="email" value="<!retainedEmail>"  title="Please enter a valid email address" placeholder="Email: name@domain.com" required>
												<span class="fa fa-asterisk form-indicator"></span> </div>
										</div>
									</div>
							...
							<fieldset class="col-sm-12" style="padding:0% 8% 4% 8%;">
										...
										<div class="form-group form-box">
											...
											<div>
												<input class="form-control required" id="password" name="password"
													...
													data-role="password" minlength="8" maxlength="35" title="Please choose a password that contains at least one number [0-9], and at least one chracter [a-z, A-Z]." pattern="(?=.*\d)(?=.*[a-zA-Z]).{8,}" required>
												<span class="fa fa-asterisk form-indicator"></span> </div>
										</div>
									</div>
									<div class="col-lg-6 col-md-6 col-sm-6">
										<div class="form-group form-box">
											...
											<div>
												<input class="form-control required" id="confirmNewPassword" name="confirmNewPassword"
													data-role="matchField:password" minlength="8" maxlength="35"
													type="password" value="" placeholder="Confirm New Password" title="Please confirm your password" required>
												<span class="fa fa-asterisk form-indicator"></span> </div>
										</div>
									</div>
								...
								<div class="row">
									<div id="passwordMatchError" class="col-lg-12 col-md-12 col-sm-12" style="text-align:center; background:#EC4F4F; border-radius:0.33em; padding:0.66em; display:none;">
										<h5>Please input matching passwords</h5>
									</div>
								</div>
							</fieldset>
							<fieldset class="col-sm-12" style="padding:0% 8% 4% 8%;">
								<div class="row">
									...
									Please enter your sign-up code or credit card information below. Once your payment method has been processed, you will be automatically logged into your Telespine portal.</p>
									<div class="col-lg-1 col-md-1 col-sm-1" style="padding-top: 5px;">
										<input id="input-checkbox-promo" type="radio" id="usePromoCodeTrue" name="usePromoCode" value="2" style="margin-top:8px;" checked>
									</div>
									<div class="col-lg-11 col-md-11 col-sm-11">
										<h5>Using a sign-up code?</h5>
										<div class="col-lg-12 col-md-12 col-sm-12">
											<div class="form-group form-box" id="billingPromoDiv" style="display:block;">
												<div>
													<input class="form-control required" id="promocode" name="promocode" required
													type="text" placeholder="Sign-up Code" minlength="5" maxlength="135" title="Please enter your sign-up code.">
													<span class="fa fa-asterisk form-indicator"></span> </div>
											</div>
										</div>
										<div id="signupCodeMatchError" class="col-lg-12 col-md-12 col-sm-12" style="text-align:center; background:#EC4F4F; border-radius:0.33em; padding:0.66em; display:none;">
											<h5>Invalid Sign-Up Code</h5>
										</div>
									</div>
                                                                <div class="col-lg-1 col-md-1 col-sm-1" style="padding-top: 5px;">
										<input id="input-radio-cc" type="radio" id="usePromoCodeFalse" name="usePromoCode" value="1" style="margin-top:8px;" <!chk>>
									</div>
									<div class="col-lg-11 col-md-11 col-sm-11">
										<h5>Using a credit card?</h5>
										<div style="padding-left:24px;display:none;" id="billingCCDiv">
										...
										<div class="row">
											<div class="col-lg-12 col-md-12 col-sm-12">
												<div class="form-group form-box">
													...
													max-length="24" type="text" value="<!retainedcardNumber>" 
													placeholder="4123412341234123 (no '-')"  
													data-role="isPromoChecked|numbers-only" minlength="1" maxlength="24" title="Please enter your credit card number with no dashes included" pattern="[0-9]{13,16}" required>
													</div>
												</div>
											</div>
											<div class="col-lg-5 col-md-5 col-sm-5">
												<div class="form-group form-box">
													...
													data-role="isPromoChecked|selected" title="Please enter the expiration month of your credit card" required>
															<!monthsOptions>
														</select>
														<span class="fa fa-asterisk form-indicator"></span> </div>
												</div>
											...
											<div class="col-lg-3 col-md-3 col-sm-3">
												<div class="form-group form-box">
													...
													type="password" value="<!retainedcvvNumber>" max-length="4" 
													placeholder="CVV2" title="CVV2 number is on the back of your card" 
													data-role="isPromoChecked|numbers-only" minlength="2" maxlength="4"  title="Please enter the CVV code found on the back of your credit card" required tocomplete="OFF">
														<span class="fa fa-asterisk form-indicator"></span> </div>
												</div>
											</div>
										</div>
										...
										<div class="row">
											<h5>Billing Address <span id="cardType"></span></h5>
											<div class="col-lg-12 col-md-12 col-sm-12">
												<div class="form-group form-box">
													<div class="">
														<input class="form-control required" id="address1" name="address1" type="text" value="<!retainedadd1>" placeholder="Address (1)" data-role="isPromoChecked|not-blank" minlength="5" maxlength="135" title="Please enter a billing address." required>
														<span class="fa fa-asterisk form-indicator"></span> </div>
												</div>
											</div>
											<div class="col-lg-12 col-md-12 col-sm-12">
												<div class="form-group form-box">
													<div class="">
														<input class="form-control required" id="address2" name="address2" type="text" value="<!retainedadd2>" placeholder="Address (2)" data-role="!not-blank" minlength="5" maxlength="135">
													</div>
												</div>
											</div>
											<div class="col-lg-5 col-md-5 col-sm-5">
												<div class="form-group form-box">
													...
													type="text" value="<!retainedcity>" placeholder="City"  
													data-role="isPromoChecked|not-blank" minlength="2" maxlength="35" title="Please enter your billing city" required>
														<span class="fa fa-asterisk form-indicator"></span> </div>
												</div>
											</div>
											<div class="col-lg-3 col-md-3 col-sm-3">
												<div class="form-group form-box">
													<div>
														  <select id="state" name="state" class="required" data-role="isPromoChecked|selected" required> <!stateOptions>	</select>
														<span class="fa fa-asterisk form-indicator"></span> </div>
												</div>
											</div>
											<div class="col-lg-3 col-md-3 col-sm-3">
												<div class="form-group form-box">
													...
													type="text" value="<!retainedzip>" placeholder="Zip"  
													data-role="isPromoChecked|numbers-only" minlength="4" maxlength="11" title="Please enter a valid US billing zipcode" pattern="(\d{5}([\-]\d{4})?)" required>
														<span class="fa fa-asterisk form-indicator"></span> </div>
												</div>
											</div>
											<div class="clearfix"></div>
										...
										<div class="row"> 
											<h5>Discount Coupon<span id="discount"></span></h5>
                                            <div class="col-lg-12 col-md-12 col-sm-12">
												<div class="form-group form-box">
													<div class="">
														<input class="form-control required" id="discount_coupon" name="discount_coupon" type="text" value="<!retaineddiscount_coupon>" placeholder="Discount Coupon" data-role="!not-blank" minlength="11" maxlength="15">
													</div>
												</div>
											</div>
											<div id="discountCodeMatchError" class="col-lg-12 col-md-12 col-sm-12" style="text-align:center; background:#EC4F4F; border-radius:0.33em; padding:0.66em; display:none;">
												<h5>Invalid Discount Coupon Code</h5>
											</div>
                                        </div>
										...
										<div class="row">
											...
											<div class="col-lg-11 col-md-11 col-sm-11">
												<div class="form-group form-box">
													<div>
														<input type="hidden" class="form-control required" id="purhcase_price" name="purhcase_price"
													type="number" value="" max-length="4" 
													placeholder="purhcase_price" title="CVV2 number is on the back of your card" 
													data-role="isPromoChecked|numbers-only" required>

													<h2 class="pull-right">Total : <span id="pricetag"></span></h2>
												</div>
											</div>											
						...
						<div class="col-sm-12 form-actions" style="padding:0px 1% 4% 6%;">
							<input type="checkbox"  name="toi_chk" id="toi_chk" value="1"  required    <!toichked> > <!--class="large"-->
...
<script src="assets/js/custom_form_scripts-v.1.js"></script>
<!-- inline scripts related to this page --> 
<script>
function chk_toi(){
