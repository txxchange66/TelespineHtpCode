...
<div id="container">
	...
	<!--<div id="breadcrumbNav">
		...
		<tr>
			...
			<!--
			function handleAction(s, id ,a_id,day)
			{
				...
				search=$('#search').val();
				if (c) window.location.href = 'index.php?action=customize_articles_automatic&plan_id=<!plan_id>&sort=<!sort>&order=<!order>&' + 'act=' + a + '&article_id=' + id +'&search='+search+'&page=<!page>&day='+ day;
			}
