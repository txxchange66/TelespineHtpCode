...
<div id="mainContent">
    <table><tr style="height:14px;"><td></td></tr></table>
<div id="tab">
	<select name="weekselect"  onChange="handleWeekAction(this)">
	<!automaticduration>
	</select> 
	<!weekday> </div>

<script type="text/javascript">
function handleWeekAction(s){
var a = s.options[s.options.selectedIndex].value;
b=eval((a*7)-6);
  window.location.href = 'index.php?action=automaticscheduling&w=' + a +'&day='+b;  
}
function handlePatientArticleAction(s, id,pid, paid)
	{
		...
		if (c) window.location.href = 'index.php?action=remove_automatic_article&article_id=' + id +'&patientArticleId='+ paid +'&day='+ <!day>;
	}
...
function add_goal(){
         ...
         GB_showCenter('Add Goal', '/index.php?action=add_goal_automatic&therapistId=<!therpaistId>&ehsunsub=<!ehsunsub>&day=<!day>', 125, 455 );
...
function handlePlanAction(s, p2p_id)
{
	...
	s.options.selectedIndex = 0;
	if (c) window.location.href = 'index.php?action=automaticscheduling&' + 'act=' + a + '&plan_id=' + p2p_id + '&day=<!day>';
}
...
<tr><td colspan="2"> <div id = "messageDiv" style="display:block;"><span style="color:#54A113;font-weight:bold;padding:0px;margin:0px;"><!mass_message_message><!removePlanAricleMsg></div><div id="top7" style="color:#54A113;font-weight:bold;padding:0px;margin:0px;display:none;">Your goal has been queued for processing. This process could take a from a few minutes to a few hours.<tr><td>&nbsp;</td></tr></div></span></td></tr>
	...
	<tr>
		...
		<table border="0" cellpadding="2" cellspacing="1" width="100%"
			...
			<tr>
				<td colspan="2" style="padding-bottom: 5px; border-bottom:0px;"><span
                                        style="font-size: 110%; color: #ed1f24; font-weight: bold; text-transform: uppercase;"><!labelAssignedPlans></span><span style="padding-bottom: 5px; border-bottom:0px; padding-left: 75px;"> <a href="/index.php?action=createNewAutomaticPlan&ehsflag=2&type=finish&day=<!day>"><b>Create Health Video Series</b></a>&nbsp;&nbsp;&nbsp;&nbsp;<a href="/index.php?action=therapistAutomaticPlan&ehsflag=1&path=my_patient&day=<!day>"><b>Assign Health Video Series Template</b></a></span>
		...
		<div
			...
			href="index.php?action=assign_articles_automatic&day=<!day>">Assign New Article</a></div>
						...
						<tr>
							<tr>
								...
								<a href="javascript:void(0);"
									onclick="GB_showCenter('Change Reminders', '/index.php?action=editReminderautomatic&patient_id=<!therpaistId>&ehsunsub=<!ehsunsub>&day=<!day>', 550, 800 );">Change
								Reminders</a></div>
								</h3>
								</td>
							</tr>
