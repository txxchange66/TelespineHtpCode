...
<table cellpadding="0" cellspacing="0" border="0">
	<tr>
		...
		<br>
<form name="detailform" id="detailform" enctype="multipart/form-data" method="POST" action="index.php?action=createNewAutomaticPlan&ehsflag=1&type=finish" onsubmit="return validateForm()">			
