...
<!--div id="breadcrumbNav">
	...
	<div align="left">
		<form name="assignform" enctype="multipart/form-data" method="POST" action="index.php?action=therapistAutomaticPlan" onSubmit="return validate_form(this);">

                    <a href="index.php?action=assigned_plan_patient_automatic&notify=1&plan_id=<!plan_id>&day=<!day>" ><img src="images/btn-assign-notify.jpg" alt="Assign &amp; Notify" /></a>
		
		<a href="index.php?action=assigned_plan_patient_automatic&plan_id=<!plan_id>&day=<!day>"><img src="images/btn-assign-nonotify.jpg" alt="Assign w/o Notification" /></a>
