...
<script language="JavaScript">
<!--
function handleAction(s,ptId ,id,day)
{
	...
	if (c) window.location.href = 'index.php?action=removeReminderautomatic&therpaistId='+ptId+'&id=' + id +'&day='+day;
}
function doClose()
{
	if(window.opener)
...
<form name="detailform" id="detailform" enctype="multipart/form-data" method="POST" action="index.php?action=addReminderautomatic&therpaistId=<!therpaistId>&day=<!day>" onSubmit="return validate_form(this);">
...
<h1 >PATIENT REMINDERS for <!patientName> EHS Patients</h1>
...
<script language="javascript">
if( top.document.getElementById('patient_reminder') != null ){
    top.document.getElementById('patient_reminder').innerHTML = '<!reminderText>';
}
</script>
</body>
</html>
