			  ...
			  <table width="100%" border="0" style="vertical-align:middle; width:700px; ">
                    ...
                    <td ><table width="100%" border="0" cellspacing="0" cellpadding="0" style="vertical-align:middle; width:100%; height:81px;">
                      <tr>
                       <td colspan="3" style=" width:400px;">
							<div id="breadcrumbNav" style="margin-top:18px;font-size:12px;">
							<!-- links for message center and home changed. -->
							<a href="index.php?action=patient">HOME</a> / <a href="index.php?action=patient_message_listing"><!headingMessages> CENTER</a>/ <span class="highlight"  >VIEW MESSAGE</span>
							</div>
						</td>
                        <td>&nbsp;</td>
                        <td>&nbsp;</td>
                  ...
                  <tr>
                   ...
                   <div style="padding-top:26px;" >
						   ...
						   <tr>
						   	<td class="sub_header_green_new" ><div style="font-size:13px;" >REPLIES</div></td>
						   	<td class="sub_header_green_new" >&nbsp;</td>
						   </tr>
						   <tr>
						   ...
						   <!reply_message>
                            <tr>                            	
                           	  <td colspan="2" style="padding-top:9px;" >
                            		<div class="sub_header_green_new" style="font-size:13px;" >POST REPLY</div>
                            ...
                            <tr>
                            	<td colspan="2" style="padding-top:3px;"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                  <tr>
                                    ...
                                    <!-- changes made by starts here -->
                                    	<input type="submit" name="Submit"  value="Submit Reply" />
                           				<input type="hidden" name="action" value="patient_view_message" />
