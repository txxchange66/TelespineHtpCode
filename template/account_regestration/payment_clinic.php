...
<!-- End --><div id="container"><!--
   ...
   <div id="header">
    ...
    <div class=" heath-prog-con">
        <h1>Tx Xchange Telehealth Software</h1>
...
<div class="key-feature-rgt-inner"><h1>&#36;<!HealthProgramPrice> <!HealthProgramDuration></h1><!HealthProgramData><!RegistrationMessage> </div>
...
<form name="patientSubs" id="patientSubs" action="index.php" method="post" onsubmit="return disableButton();">
    <input type="hidden" name="action" value="submit_clinic_payment">
 ...
 --><tr >
     ...
     <td colspan="4" class="yellow-btn" style="padding-top:40px;" align="center"><input name="Submit" type="submit" value="Start Using Tx Xchange" style="border-left: 1px solid #fe9a22" class="rgt" id="submitbutton" />  <a href="javascript:void(0);"  title="" onclick="GB_showCenter('Refund Policy', '/index.php?action=show_refund_policy_clinic',193,600);">Refund Policy</a></td>
