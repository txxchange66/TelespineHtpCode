              ...
              //  alert(c);
				switch (a)
				{
					...
					case 'edit_instruction':
						...
						if(!g_win) var g_win = window.open('index.php?action=edit_instruction_ehs&id='+ id, 'TreatmentInstructions','width=750, height=480, status=no, toolbar=no, resizable=1');
						g_win.focus();
						c = false;
						break;
					default:
	...
	<!customize_instruction_rec>
			...
			<tr class="input">
				<td colspan="2" align="center">
					...
					<input type="image" src="images/btn-next.jpg" value="Next" onClick="window.location.href='index.php?action=customize_articles_ehs&plan_id=<!plan_id>'" /></td>
			</tr>
			</table>
					</div>
