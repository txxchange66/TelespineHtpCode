<div id="mainContent">
			<script language="JavaScript" src="js/validateform.min.js"></script>
...
<form name="detailform" id="detailform" enctype="multipart/form-data" method="POST" action="index.php?action=edit_instruction_ehs" onSubmit="return validate_form(this);">

<table border="0" cellpadding="2" cellspacing="1" width="100%">
	<tr class="input">
		<td><div style="width:160px"><label for="or_instruction" onMouseOver="help_text(this, 'Edit your treatment instructions')")><!labelDefaultInstructions>:&nbsp;</label></div></td>
	...
	<tr class="input">
		<td><div style="width:160px"><label for="or_instruction" onMouseOver="help_text(this, 'Edit your treatments benefits')")><!labelBenefitofTreatment>:&nbsp;</label></div></td>
