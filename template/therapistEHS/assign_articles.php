	...
	<tr><td style=" width:400px;">
		...
		<div id="page_nav" style="text-align:right;">
			...
			function handleAction(s, id ,pid,paid)
			{
				...
				search=$('#search').val();
				if (c) window.location.href = 'index.php?action=assign_articles_ehs&sort=<!sort>&order=<!order>&page=<!page>&' + 'act=' + a + '&article_id=' + id + '&patient_id=' + pid + '&patientArticleId=' + paid +'&search='+search;
			}
