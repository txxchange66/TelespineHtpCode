...
<div id="mainContent">
<table style="vertical-align:middle;width:700px;"><tr><td style="width:400px;"><div id="breadcrumbNav"><a href="index.php?action=articleList" >ARTICLE</a> / <span ><!articleBreadcrumb></span> / <span class="highlight">EDIT ARTICLE</span></div></td><td style="width:300px;"><table border="0" cellpadding="5" cellspacing="0" style="float:right;">
<tr>
...
<tr class="input">
	...
	<td width="100%"><select size="1" style="width:100px;" class="action_select" onChange="handle_action(this, <!article_id>)"><option value="">Actions...</option><option value="delete" id="act_delete">Delete Article</option></select>		
		</td>
</tr>
<tr>
		<td colspan="2">&nbsp;</td>
...
<tr class="input" align="left">
	...
	<input type="hidden" name="submitted_save" value="Save Changes">
		<input type="hidden" name="action" value="articleEdit" />
		
	<a  href="index.php?action=confirmPopupArticleEdit" title="Edit Article" rel="gb_page_center[600, 310]"><input type="button" name="submitted_save" value="Save Changes"></a>		
	</td>
</tr>
</table>
