        ...
        */
        ...
        var init = function(tableId) {
                ...
                for(var t = 0, tbl; tbl = tables[t]; t++) {
						...
						//if(maxPages % 2 == 0 && maxPages > 1) { maxPages--; };  Modified By Abhishek Nigam : Dated 02-11-2010
                        if(maxPages % 3 == 0 && maxPages > 1) { maxPages--; };
        ...
        var buildPagination = function(tblId) {
                ...
                if(details.numPages > 1) {
                        createButton({title:resolveText(text[1], details.currentPage-1), className:"previous-page", text:"<<Previous", id:tblId+"-previousPage"}, ulT, details.currentPage == 1);
                        createButton({title:resolveText(text[1], details.currentPage-1), className:"previous-page", text:"<<Previous", id:tblId+"-previousPageC"}, ulB, details.currentPage == 1);
                };
                ...
                if(details.numPages > 1) {
                        createButton({title:resolveText(text[2], details.currentPage + 1), className:"next-page", text:"Next>>", id:tblId+"-nextPage"}, ulT, details.currentPage == details.numPages);
                        createButton({title:resolveText(text[2], details.currentPage + 1), className:"next-page", text:"Next>>", id:tblId+"-nextPageC"}, ulB, details.currentPage == details.numPages);
                };
